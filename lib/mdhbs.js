...
(function() {
  var compileTemplate, fileFilter, filelet, fs, funclet, handlebars, isFunction, loadTemplateHelper, loadTemplates, loglet, marked, monitors, path, registerHelpers, render, renderFile, renderKey, renderLayout, renderRelKey, templateChanged, templateCreated, templateEvent, watch, _;
  ...
  fileFilter = function(filePath, stat) {
    var ext;
    ext = path.extname(filePath);
    return stat.isDirectory() || ext === '.md' || ext === '.hbs';
  };
