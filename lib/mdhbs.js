...
(function() {
  ...
  registerHelper('validateError', function(context, options) {
    var ref, ref1, ref2;
    ...
    if ((options != null ? (ref = options.data) != null ? (ref1 = ref.root) != null ? (ref2 = ref1.error) != null ? ref2.errors : void 0 : void 0 : void 0 : void 0) && options.data.root.error.errors.hasOwnProperty(context)) {
      return new handlebars.SafeString('<span class="has-error">' + options.data.root.error.errors[context] + '</span>');
    } else {
