...
(function() {
  var baseErrorHandler, bean, bodyParser, cookieParser, cookieSession, express, extless, favicon, filelet, fs, http, https, initLastMiddlewares, initMiddlewares, initRoutes, localRequire, loglet, mdhbs, methodOverride, path, run, runStatic, runWithConfig, session, setupSSL, signedSecret, uuid, wapi, _;
  ...
  runWithConfig = function(config) {
    var app, sessionConfig, _ref, _ref1, _ref2;
    ...
    app.use(cookieParser(((_ref2 = config.session) != null ? _ref2.secret : void 0) || signedSecret));
    sessionConfig = {
      genid: function(req) {
        return uuid.v4();
      }
