...
(function() {
  var baseErrorHandler, bean, bodyParser, cookieParser, cookieSession, express, extless, favicon, filelet, fs, http, https, initLastMiddlewares, initMiddlewares, initRoutes, localRequire, loglet, methodOverride, path, run, runStatic, runWithConfig, session, setupSSL, signedSecret, uuid, _;
